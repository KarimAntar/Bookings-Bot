...
const result = {
  ...
  confidence: 0.9,
  evidenceRoles: [{ imageId: "original:1", roles: ["crm_prospect"], readable: true }],
  ...
  notesSummary: { present: true, contentSummary: "Annual sales entry is missing.", requiredEntriesPresent: false },
